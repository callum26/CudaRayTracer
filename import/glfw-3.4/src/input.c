...
{
    assert(window != NULL);
    assert(xoffset > CUDART_NINF);
    assert(xoffset < CUDART_INF);
    assert(yoffset > CUDART_NINF);
    assert(yoffset < CUDART_INF);
...
{
    assert(window != NULL);
    assert(xpos > CUDART_NINF);
    assert(xpos < CUDART_INF);
    assert(ypos > CUDART_NINF);
    assert(ypos < CUDART_INF);
